...
run_cmd("git checkout -B chore/repo-discoverability")
...
run_cmd("git push -f origin chore/repo-discoverability")
...
time.sleep(1)
run_cmd('gh pr merge chore/repo-discoverability --squash --delete-branch')
...
run_cmd("git checkout main && git pull origin main")
run_cmd("git checkout -B chore/repo-governance")
...
run_cmd("git push -f origin chore/repo-governance")
...
time.sleep(1)
run_cmd('gh pr merge chore/repo-governance --squash --delete-branch')

# --- PR 4: Public Release Maturity ---
run_cmd("git checkout main && git pull origin main")
run_cmd("git checkout -B release/v2.9.0-notes")
...
run_cmd("git push -f origin release/v2.9.0-notes")
...
time.sleep(1)
run_cmd('gh pr merge release/v2.9.0-notes --squash --delete-branch')

# --- PR 5: Architecture Visibility & Diagrams ---
run_cmd("git checkout main && git pull origin main")
run_cmd("git checkout -B docs/arch-visuals")
...
run_cmd("git push -f origin docs/arch-visuals")
...
time.sleep(1)
run_cmd('gh pr merge docs/arch-visuals --squash --delete-branch')
